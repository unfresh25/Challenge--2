...
A continuación crearemos una función más completa para la validación y construcción de un modelo de regresión lineal múltiple. En ella vamos a seguir los siguientes pasos de construcción de un modelo, ignorando el primer paso del ajuste de este.
...
Ahora, evaluemos el modelo (`fit`) utilizando la función creada
